...
export namespace GetGoalBySonarTaskData {
...
export namespace SonarScanRequestedGoal {
  export type Variables = {};
...
export namespace SonarScanCompleted {
  export type Variables = {};

  export type Subscription = {
    __typename?: "Subscription";

    SonarScan?: (SonarScan | null)[] | null;
  };
